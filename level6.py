...
#answer feedback box
def option1():
    resp = messagebox.askokcancel("Confirm?", "Are you sure!")
    if resp == True:
        final_check()
...
def sixth_level(Timer4, Title4, Marks4, Skip4, Next4, CountScreen4, id4, next_game_call):
    ...
    option1tick_btn = Button(root5, image=option1tick_img,command=option1, borderwidth=0,highlightthickness=0, height = 60, width= 90)
    option1tick_btn.place(x=112, y=535)

    option2tick_btn = Button(root5, image=option2tick_img,command=option2, borderwidth=0, highlightthickness=0, height = 60, width= 90)
    option2tick_btn.place(x=292,y=535)

    option3tick_btn = Button(root5, image=option3tick_img,command=option3, borderwidth=0, highlightthickness=0, height = 60, width= 89)
    option3tick_btn.place(x=465, y=535)

    option4tick_btn = Button(root5, image=option4tick_img,command=option4, borderwidth=0, highlightthickness=0, height = 60, width= 90)
    option4tick_btn.place(x=621, y=535)
