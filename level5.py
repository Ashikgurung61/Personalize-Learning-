...
#create message box for answer is correct or wrong
    ...
    option1tick_btn = Button(root4, image=option1tick_img,command=option1, borderwidth=1,highlightthickness=1)
    option1tick_btn.place(x=115, y=580)

    option2tick_btn = Button(root4, image=option2tick_img,command=option2, borderwidth=1, highlightthickness=1)
    option2tick_btn.place(x=295, y=580)

    option3tick_btn = Button(root4, image=option3tick_img,command=option3, borderwidth=1, highlightthickness=1)
    option3tick_btn.place(x=475, y=580)

    option4tick_btn = Button(root4, image=option4tick_img,command=option4, borderwidth=1, highlightthickness=1)
